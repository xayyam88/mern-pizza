...
const PizzaNavigation = React.memo(function PizzaNavigation({
    items,
    activeCategory,
    onClickCategory,
    navBarPosition
    ...
    return (
        <nav className="secondary-navigation" role="navigation">
            <ul id="menu-food-menu-1" className="menu">
                {navBarPosition && (
